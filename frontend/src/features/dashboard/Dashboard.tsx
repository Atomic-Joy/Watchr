                    ...
                    <div key={idx} className="group relative flex items-center p-4 bg-slate-950/50 rounded-2xl border border-slate-800/50 hover:border-indigo-500/30 transition-all cursor-pointer overflow-hidden">
                      ...
                      <div className="flex-1 relative z-10">
                        ...
                        <div className="flex items-center text-sm text-slate-400 mt-1">
                          ...
                          <span>{item.progress_percent.toFixed(0)}% watched</span>
                        </div>
                      </div>
                      <button className="ml-4 p-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white shadow-lg shadow-indigo-500/20 transition-all transform hover:scale-105 active:scale-95">
              ...
              {loadingNotifs ? (
                ...
                <div className="space-y-5 relative z-10">
                  {notifications.map((notif: any) => (
                    <div key={notif.id} className="relative pl-4 border-l-2 border-indigo-500/50 hover:border-indigo-400 transition-colors">
                      <div className="absolute -left-[5px] top-1.5 w-2 h-2 bg-indigo-500 rounded-full shadow-[0_0_10px_rgba(99,102,241,0.8)]" />
